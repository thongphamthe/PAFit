...
\title{
  Printing a \code{CV_Result} object
}
\description{
  This function prints a \code{CV_Result} object's information.
}
\usage{
...
\arguments{
\item{x}{
An object of class \code{CV_Result}, containing the cross-validation result of the \code{\link{performCV}} function.
}
\item{\dots}{
...
\examples{
library("PAFit")
net        <- GenerateNet(N = 50 , m = 10 , mode = 1 , alpha = 0.5 , shape = 10, rate = 10)
