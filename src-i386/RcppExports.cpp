...
int normalized_constant_alpha(NumericVector& norm, const double& alpha, const NumericMatrix& degree, const NumericVector& theta, const NumericVector& f, const NumericMatrix& offset_tk);
RcppExport SEXP PAFit_normalized_constant_alpha(SEXP normSEXP, SEXP alphaSEXP, SEXP degreeSEXP, SEXP thetaSEXP, SEXP fSEXP, SEXP offset_tkSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector& >::type norm(normSEXP);
    ...
    Rcpp::traits::input_parameter< const NumericVector& >::type f(fSEXP);
    Rcpp::traits::input_parameter< const NumericMatrix& >::type offset_tk(offset_tkSEXP);
    __result = Rcpp::wrap(normalized_constant_alpha(norm, alpha, degree, theta, f, offset_tk));
    return __result;
END_RCPP
}
// get_stats
...
// update_alpha
double update_alpha(const NumericVector& non_zero_theta, const NumericVector& norm, const NumericVector& f, const NumericVector& theta, const NumericMatrix& degree, const NumericVector& m_t, const NumericVector& Sum_m_k, const NumericMatrix& offset_tk);
RcppExport SEXP PAFit_update_alpha(SEXP non_zero_thetaSEXP, SEXP normSEXP, SEXP fSEXP, SEXP thetaSEXP, SEXP degreeSEXP, SEXP m_tSEXP, SEXP Sum_m_kSEXP, SEXP offset_tkSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    ...
    Rcpp::traits::input_parameter< const NumericMatrix& >::type offset_tk(offset_tkSEXP);
    __result = Rcpp::wrap(update_alpha(non_zero_theta, norm, f, theta, degree, m_t, Sum_m_k, offset_tk));
    return __result;
END_RCPP
}
// coeff_theta
